    ...
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm mb-4">
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                <span class="text-white me-3 small">NIS: <?php echo e(Auth::guard('siswa')->user()->nis); ?> (Kelas <?php echo e(Auth::guard('siswa')->user()->kelas); ?>)</span>
                ...
                <div class="card card-stats bg-white shadow-sm p-3 mb-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 fw-bold"><?php echo e($total); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-stats bg-white shadow-sm p-3 mb-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 fw-bold"><?php echo e($proses); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-stats bg-white shadow-sm p-3 mb-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 fw-bold"><?php echo e($selesai); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="id_kategori" class="form-select" required>
                    ...
                    <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k->id_kategori); ?>"><?php echo e($k->ket_kategori); ?></option>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $aspirasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                        $statusData = \App\Models\Aspirasi::where('id_pelaporan', $a->id_pelaporan)->first();
                                    ?>
                                    <tr>
                                        <td class="ps-3">
                                            <div class="fw-bold text-primary">#<?php echo e($a->id_pelaporan); ?> - <?php echo e($a->kategori->ket_kategori); ?></div>
                                            <div class="small text-muted"><i class="bi bi-geo-alt"></i> <?php echo e($a->lokasi); ?></div>
                                            <div class="small mt-1"><?php echo e(Str::limit($a->ket, 50)); ?></div>
                                        </td>
                                        <td>
                                            <span class="badge <?php if($statusData->status == 'Menunggu'): ?> bg-warning text-dark <?php elseif($statusData->status == 'Proses'): ?> bg-info <?php else: ?> bg-success <?php endif; ?>">
                                                <?php echo e($statusData->status); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if($statusData->feedback): ?>
                                                <div class="p-2 rounded bg-light small border-start border-primary border-3">
                                                    <?php echo e($statusData->feedback); ?>
...
<div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ms-auto align-items-center">
        <li class="nav-item">
            <span class="nav-link text-white me-3 small d-none d-lg-block">NIS: <?php echo e(Auth::guard('siswa')->user()->nis); ?></span>
        </li>
        <li class="nav-item">
...
</html><?php /**PATH C:\xampp\htdocs\pengaduansaranasekolahhUKK12\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>